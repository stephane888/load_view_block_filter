 ...
 * )
 */
class LoadViewBlockFilterBlock extends BlockBase implements
  ...
  public function __construct(array $configuration, $plugin_id,
      $plugin_definition, RequestStack $RequestStack) {
  ...
  public function blockForm($form, FormStateInterface $form_state) {
    $form['foo'] = ['#type' => 'textarea', '#title' => $this->t('Foo'),
  ...
  public function build() {
    ...
    foreach ($query as $key => $value) {
      if (!empty($view->filter[$key]) && !empty($value) && $value != 'All') {
